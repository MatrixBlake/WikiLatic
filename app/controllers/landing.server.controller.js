...
module.exports.showLandingPage=function(req,res){
	...
	if(req.url.indexOf('wrong')>-1){
		res.render("landing.ejs",{wrong:1,register:0,repeatUsername:0,repeatEmail:0})
	}else{
		res.render("landing.ejs",{wrong:0,register:0,repeatUsername:0,repeatEmail:0})
	}
...
module.exports.register=function(req,res){
	...
	function function3(){
	res.render("landing.ejs",{wrong:0,register:1,repeatUsername:repeatUsername,repeatEmail:repeatEmail})
	}
